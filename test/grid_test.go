...
// :v: 2018-03-12 02:30:19 E3B34A                            [test/grid_test.go]
// -----------------------------------------------------------------------------
...
// gridTestResult generates a PDF with a unit grid and
// returns the generated PDF as an uncompressed string
...
// gridTestExpect is the expected result string
const gridTestExpect = `
%PDF-1.4
...
func Test_DrawUnitGrid_(t *testing.T) {
	//
	var expects = formatPDFLines(gridTestExpect)
	var results = formatPDFLines(gridTestResult())
